...
-(void)main
{
	...
	//NSTimer *progressUpdateTimer = [NSTimer timerWithTimeInterval:1.0 target:sharedKryptomatorInstance selector:@selector(didReceiveProgressUpdate:) userInfo:[NSNumber numberWithInt:bytes repeats:YES];
	NSNumber *newBytesRead;
	unsigned char *stop;
...
+ (NSString*) pluginName
{
	return @"ROT128";   //the name of your plugin
}
